          ...
          <>
            ...
            <div style={styles.resendRow}>
              {resendTimer > 0 ? (
                ...
                <button style={styles.resendBtn} onClick={handleResend}>Resend OTP</button>
              )}
            </div>
          </>
        )}
...
const styles = {
  ...
  resendBtn: { background: "none", border: "none", color: "#2c3e50", cursor: "pointer", fontSize: "0.88rem", textDecoration: "underline" },
